            ...
            <ul class="service-list">
              <li class="service-item">
                <div class="service-item-icon">
                  <img
                    src="./src/assets/images/service-icon-1.svg"
                    alt="Service icon"
                  />
                </div>
              ...
              <li class="service-item">
                <div class="service-item-icon">
                  <img
                    src="./src/assets/images/service-icon-2.svg"
                    alt="Service icon"
                  />
                </div>
              ...
              <li class="service-item">
                <div class="service-item-icon">
                  <img
                    src="./src/assets/images/service-icon-3.svg"
                    alt="Service icon"
                  />
                </div>
              ...
              <li class="service-item">
                <div class="service-item-icon">
                  <img
                    src="./src/assets/images/service-icon-4.svg"
                    alt="Service icon"
                  />
                </div>
